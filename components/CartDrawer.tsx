...
const ShoppingBagIcon = ({ className }: { className?: string }) => <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4Z"/><path d="M3 6h18"/><path d="M16 10a4 4 0 0 1-8 0"/></svg>;
const Trash2Icon = ({ className }: { className?: string }) => <svg className={className} xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/><line x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/></svg>;
const ArrowRightIcon = ({ className }: { className?: string }) => <svg className={className} xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>;
              ...
              <div className="space-y-6">
                ...
                <div className="bg-blue-50 border border-blue-100 rounded-xl p-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-[10px] font-bold text-blue-700 uppercase tracking-widest">Smart Picks</span>
                  </div>
                  <p className="text-sm text-blue-900 leading-relaxed italic">
                    {loadingSuggestion ? "Thinking of things you might like..." : suggestion}
                  </p>
                </div>
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center bg-gray-100 rounded-lg p-0.5">
                            <button 
                              ...
                              className="w-6 h-6 flex items-center justify-center text-gray-600 hover:text-green-600 font-bold"
                            >
                              -
                            </button>
                            <span className="mx-2 text-xs font-bold min-w-[1rem] text-center">{item.quantity}</span>
                            <button 
                              onClick={() => onUpdateQuantity(item.id, 1)}
                              className="w-6 h-6 flex items-center justify-center text-gray-600 hover:text-green-600 font-bold"
                            >
          ...
          {items.length > 0 && (
            <div className="border-t p-6 space-y-4 bg-white">
              <div className="space-y-2">
                ...
                {deliveryFee > 0 && (
                  <p className="text-[10px] text-orange-600 font-medium">Add ₹{500 - subtotal} more for FREE delivery</p>
                )}
              ...
              <button 
                onClick={onCheckout}
                className="w-full bg-green-600 text-white flex items-center justify-center gap-2 py-4 rounded-xl font-bold hover:bg-green-700 transition-all shadow-lg active:scale-95"
              >
                Checkout Now
                <ArrowRightIcon />
              </button>
